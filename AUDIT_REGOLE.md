...
| **O18 Artillery Request** (radio/spotter/barrage) | 🟡 | l'ordine ARTI è giocabile: serve una Radio e un Leader (spotter) non rotti; **Targeting Roll** spotter→bersaglio, **deriva** della granata coi dadi del Fato (colpito/mancato, O18.2.2) ed eventuale uscita dalla mappa, **impatto a 7 esagoni** (centro+adiacenti) con attacco da FP per calibro (75/81/88/105 → 16/18/20/24). Il giocatore **posa manualmente** la Spotting Round cliccando un esagono nella LOS dello spotter (gli esagoni validi sono evidenziati); l'**IA** auto-sceglie il cluster nemico migliore. **Distruzione fortificazioni** (O18.2.3.3): l'artiglieria pesante (FP≥20) spiana le fortificazioni nell'area prima dei tiri di difesa. **Barrage fumogeno** (O18.2.3.1): tasto «S» durante il targeting per posare fumo sui 7 esagoni invece dell'esplosivo. Resta da modellare: la «Fortification Vulnerability» esatta per calibro e la capacità «Smoke» specifica per radio (qui ogni radio può posare fumo). |
