...
| Comando/Leadership | ✅🟡 | Bonus nello stesso esagono ✅; **raggio di Comando multi-esagono** ✅ (un leader estende il gruppo di fuoco alle unità idonee entro il suo comando, `Combat.fire_group`). Resta l'attivazione multi-unità per ordini non-fuoco (es. mossa di gruppo). |
